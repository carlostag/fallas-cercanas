...
# Cargar los datos
data_fallas_adultas = cargar_datos('D:/culo/falles-fallas.csv', 'Falla Adulta')
data_fallas_infantiles = cargar_datos("D:/culo/falles-infantils-fallas-infantiles.csv", 'Falla Infantil')
